...
!--------------------------------------------------------------
     ...
     >         dt_cmt
      ...
      !print *,"setdtcmt before de_particles",nid
      call set_dt_particles(rdt_part)
      !print *,"setdtcmt after  dt_particles ",nid
...
!     call mindr(mdr,diffno2)
      !print *,"setdtcmt before glsqinvcolmin 2 ",nid
      ...
      !print *,"setdtcmt after glsqinvcolmin 2 ",nid
...
!                         polynomial order
     ...
     >                 (zcrn(ic2)-zcrn(ic1))**2
         ...
         h(e)=dist*rp
          ...
          !if(nid.eq.15) then
          !   do aa=1,8
          !     print *, 'xcrn,ycrn,zcrn',xcrn(aa),ycrn(aa),zcrn(aa)
          !     print *, 'xm1,ym1,zm1',x(aa),y(aa),z(aa)
          !   enddo
          ! print *,"$$$ step.f compute_meshh check", nid
          ! print *, 'e, dist , rp ',e,dist,rp
          !endif
